...
import { ArrowRight, Palette, Globe, MessageSquare, PenTool, Instagram, Facebook, Linkedin } from "lucide-react"
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
          <div className="flex gap-2 items-center text-xl font-bold">
            <Image src="wavydoglogo.svg" width={24} height={24} alt="Wavy Dog Logo" />
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Elevate your brand with custom design and marketing strategies tailored to your unique business
                    needs.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
                  Comprehensive design and marketing solutions for businesses of all sizes
                </p>
              </div>
            </div>
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">About Wavy Dog Design</h2>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    We're passionate about helping businesses of all sizes stand out with exceptional design and
                ...
                <ul className="grid gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-primary" />
                    <span>Commitment to delivering results that exceed expectations</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <ArrowRight className="h-4 w-4 text-primary" />
                    <span>Focus on creating designs that drive business growth</span>
                  </li>
                </ul>
                <div>
                  <Button asChild>
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Flexible Pricing</h2>
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
              ...
              <div className="flex flex-col rounded-lg border p-6 shadow-sm bg-primary/5 border-primary/20">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">Comprehensive solutions for established businesses</p>
                </div>
                <div className="mt-6 space-y-4">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
              ...
              <div className="flex flex-col rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">Full-service design and marketing partnership</p>
                </div>
                <div className="mt-6 space-y-4">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
            ...
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-muted-foreground">
                All packages are customizable based on your specific needs. Contact us for a personalized quote tailored
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 lg:grid-cols-2">
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex space-x-4">
                  <Link href="#" className="rounded-full bg-primary/10 p-2 text-primary hover:bg-primary/20">
