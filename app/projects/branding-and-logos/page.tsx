...
import { ArrowLeft, X, Palette, PenTool, Type, Sparkles } from "lucide-react";

export default function BrandingAndLogosPage() {
	...
	const portfolioItems = [
		{
			...
			description: "Complete brand identity and website design for a legal services firm. Professional logo design with modern typography and a sophisticated color palette.",
				...
				<section className="w-full py-12 md:py-24 lg:py-32">
					<div className="container px-4 md:px-6">
						...
						<div className="max-w-4xl mx-auto">
							...
							{/* Portfolio Examples */}
							<div className="mb-12">
								<h2 className="font-display text-2xl font-bold mb-6">Branding Portfolio</h2>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
